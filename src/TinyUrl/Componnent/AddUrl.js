    ...
    return(
        ...
        <div className="login">           
             <div className='loginDiv'><br/>
                 ...
                 <label style={{fontFamily:"revert"}}>
                  <span className="icon">🔗</span> Enter a long URL to make a TinyURL
                  </label>
                       ...
                       <input type="button"className='loginSubmit' value="Make TinyURL! ✏️" onClick={func}/><br/>
                       <Snackbar
                       open={open}
